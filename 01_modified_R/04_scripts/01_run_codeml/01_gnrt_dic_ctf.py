...
in_dir = sys.argv[1]
out_dir = sys.argv[2]
dat_file = '/data1/chenshanshan/pipeline_data/00_raw_data/lg.dat'
...
def main():
    ...
    for fasta_file in fasta_list:
        ...
        gene_codeml_str = gene_codeml_str.replace('TREEZ', os.path.abspath(f'{in_dir}/{gene_name}.nw'))
